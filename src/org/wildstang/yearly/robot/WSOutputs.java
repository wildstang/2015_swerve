...
{
   VICTOR_URD("URDrive",    WSOutputType.VICTOR,    new WsVictorConfig(1,  0.0), true),
//   VICTOR_ULD("Talon",            WSOutputType.TALON,     new WsTalonConfig(1,  0.0), true),
   VICTOR_ULD("ULDrive",    WSOutputType.VICTOR,    new WsVictorConfig(0,  0.0), true),
   VICTOR_URR("URRotate",    WSOutputType.VICTOR,    new WsVictorConfig(5,  0.0), true),
   VICTOR_ULR("ULRotate",    WSOutputType.VICTOR,    new WsVictorConfig(4,  0.0), true),
   VICTOR_LRD("LRDrive",    WSOutputType.VICTOR,    new WsVictorConfig(3,  0.0), true),
   VICTOR_LLD("LLDrive",    WSOutputType.VICTOR,    new WsVictorConfig(2,  0.0), true),
   VICTOR_LRR("LRRotate",    WSOutputType.VICTOR,    new WsVictorConfig(7,  0.0), true),
   VICTOR_LLR("LLRotate",    WSOutputType.VICTOR,    new WsVictorConfig(6,  0.0), true),
